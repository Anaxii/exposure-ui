<template>
  <div>
    ...
    <div style="margin-top: 25vh;">
      <div class="total">
        <div class="item">
          <p class="name">ETF Stats</p>
          <p>AUM</p>
          <p>TVL</p>
          <p>ETF Balances</p>
          <p>Supply % Owned by ETFs</p>
          <p># of ETFs</p>
          <p># of ETF wallets</p>
          <p>Individual ETF values</p>
          <p>Individual ETF price histories</p>
          <p>EFFs total volume</p>
          <p>ETFs volume of total underlying asset markets</p>
        </div>
      </div>
    </div>
  </div>
